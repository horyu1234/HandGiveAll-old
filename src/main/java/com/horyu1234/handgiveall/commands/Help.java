...
public class Help implements CommandExecutor {
    ...
    private void sendHelpEN(CommandSender s, String l, int page, boolean basic) {
        ...
        if (page == 0) {
            ...
            s.sendMessage("§b/hga <amount> §f- Give everyone the item in hand.");
            s.sendMessage("§b/hgar <min> <max> §f- Give everyone a random amount of item in hand within the range of <min> and <max>.");
            s.sendMessage("§b/hgac <item> <amount> §f- Give everyone <amount> amount of <item>.");
            s.sendMessage("§b/hgacr <item> <min> <max> §f- Give everyone a random amount of <item> within the range of <min> and <max>.");
            s.sendMessage("§bⓒ Horyu Systems Ltd, All Rights Reserved.");
            s.sendMessage("§6■==== §eMade By horyu1234 §6====■");
        } else if (page == 2) {
            s.sendMessage("§6■==== §e" + name + " §6====■");
            s.sendMessage("§a2. Item Info Related Commands");
            s.sendMessage("§b/hca [type] §f- Create a book with a list of players who has the same item with [type] value as the item in hand.");
            ...
            s.sendMessage("§b/dga add <name> §f- Save the item in hand to a file.");
            s.sendMessage("§b/dga remove <name> §f- Delete the saved item");
            s.sendMessage("§b/dga list §f- Create a book with list of saved items.");
            s.sendMessage("§b/dga give <player> <name> <amount> §f- Give <player> <name>.");
            s.sendMessage("§b/dga giveall <name> <amount> §f- Give everyone <name.");
            s.sendMessage("§b/dga rgive <player> <name> <min> <max> §f- Give <player> a random (with min and max) amount of <name>.");
            s.sendMessage("§b/dga rgiveall <name> <min> <max> §f-  Give everyone a random (with min and max) amount of <name>.");
            s.sendMessage("§bⓒ Horyu Systems Ltd, All Rights Reserved.");
            s.sendMessage("§6■==== §eMade By horyu1234 §6====■");
        } else if (page == 4) {
            s.sendMessage("§6■==== §e" + name + " §6====■");
            s.sendMessage("§a4. Money Related Commands");
            s.sendMessage("§b/mga give <amount> §f- Give everyone <amount> of money.");
            s.sendMessage("§b/mga take <amount> §f- Take <amount> of money from everyone.");
            s.sendMessage("§b/mga rgive <min> <max> §f- Give everyone a random amount of money within the range of <min> and <max>.");
            s.sendMessage("§b/mga rtake <min> <max> §f- Take a random amount of money from everyone within the range of <min> and <max>.");
            s.sendMessage("§bⓒ Horyu Systems Ltd, All Rights Reserved.");
            s.sendMessage("§6■==== §eMade By horyu1234 §6====■");
        } else if (page == 5) {
            s.sendMessage("§6■==== §e" + name + " §6====■");
            s.sendMessage("§a5. Potion Related Commands");
            s.sendMessage("§b/pga §f- Apply everyone the potion effect of the potion you're holding.");
